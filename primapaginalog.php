...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            <nav>
                <h1 class="brand"><a href="primapaginalog.php">Sound<span>B</span>ook</a></h1>
                <br>
                <ul>
                    <li><a href="primapaginalog.php">Home</a></li>
            ...
            <div class="modal">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" class="btnRegister" value="REGISTER" name="submit3">
                </form>
            </div>
        </div>
</header>
